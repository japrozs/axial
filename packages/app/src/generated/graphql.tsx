...
export type GetPostQuery = { __typename?: 'Query', getPost: { __typename: 'Post', id: number, creatorId: number, likes: number, description: string, imgUrl: string, createdAt: string, updatedAt: string, creator: { __typename: 'User', id: number, username: string, email: string, name: string, bio: string, imgUrl: string, createdAt: string, updatedAt: string }, comments: Array<{ __typename: 'Comment', id: number, creatorId: number, body: string, postId: number, createdAt: string, updatedAt: string }> } };
